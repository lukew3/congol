...
gameVars.data = this.createEmptyData();
initBoard();
...
const toggleCell = (cellObj, playerId) => {
    ...
    } else if (gameVars.data[cy][num % gameVars.boardSize] == playerId && gameVars.roundToggledCells.includes(num)) {
        // empty filled square
